...
document.getElementById("checkout-btn").addEventListener("click", function() {
  ...
  if (typeof Razorpay !== 'undefined') {
    var options = {
      key: "rzp_test_SLHQvDK11adRVm", // Test key (replace with actual key in production)
...
name: "MeShop Checkout",
    ...
    // Handler for payment success - clear cart after successful payment
    rzp1.on("payment.success", function(response) {
      ...
      // Refresh the cart UI to show empty cart
      initCart();
      
      // Show success message
      alert("Payment successful! Your order has been placed. Cart is now empty.");
    });
